...
const Bw = () => {
    return (
        <>
        <Helmet>
                <title>Socio Edge | Branding work</title>
            ...
            <div className="head portfolio imgg">
                <div className="container">
                    <h1 className="text-center"><strong>Branding Work </strong> </h1>
                </div>
            </div>
            ...
            <div className="bedcrumb_service">
                <div className="container-fluid">
                    <ol className="breadcrumb" vocab="" typeof="BreadcrumbList">
                        ...
                        <li><Link style={{ color: '#121212', textDecoration: 'none' }}><span>&nbsp; Branding Work</span></Link></li>
                    </ol>
                </div>
            </div>
            <br />
